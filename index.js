function error(text) {
  ...
  document.querySelector("#errortext").innerText = `Oups !!! une erreur c'est produite: ${text}`;
}
    ...
    unlockButton.addEventListener("click", async () => {
      ...
      try {
        ...
        document.querySelector("#no-redirect").href =
          `lapervenche.github.io/link-lock/decrypt/#${hash}`;

        // Set the "create hidden bookmark" URL appropriately
        document.querySelector("#hidden").href =
          `lapervenche.github.io/link-lock/hidden/#${hash}`;
        return;
      }
